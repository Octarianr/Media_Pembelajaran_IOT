		...
		if($this->session->userdata('userlogin'))     // mencegah akses langsung tanpa login
		{
			if (isset($_GET['tanggal'])) {
				...
				if (isset($datakeluar)){
					...
					header('Content-Disposition: attachment;filename="soal_'.$tanggal.'.xlsx"');
