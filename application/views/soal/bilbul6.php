      ...
      <div class="px-video-img-captions-container">
        ...
        <div class="px-video-wrapper">
          <video class="px-video" width="100%" height="auto" controls>
      			<!-- video files -->
      			<source src="http://192.168.29.25//absensi/media/bilanganbulat/perkalian/bilbul3.mp4" type="video/mp4" />
      			...
      			<div>
      				<a href="http://192.168.29.25//absensi/media/bilanganbulat/perkalian/bilbul3.mp4">
