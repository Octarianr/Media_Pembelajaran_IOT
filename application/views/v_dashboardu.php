        ...
        <div class="col-lg-12 col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <center><h3 class="box-title">Selamat datang Di Sistem Wesbsite Kuis Berbasis IOT</h3></center>
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <h3><a href="https://drive.google.com/file/d/1AXq_hfC6rWSbvtAN3x7CHVajNfLTdOiF/view?usp=share_link" target="blank"><b>Buku Panduan Pengguna</b></a></h3>
            </div>
          </div>
          <!-- /.box -->
        </div>
